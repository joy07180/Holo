...
<body>
	...
	<form action="t_binsert" method="post" enctype="multipart/form-data" class="insert_container">
	    		...
	    		<tr> <!-- ID -->
	    			<td bgcolor="#f6f5f5">
	    				<table border="0" width="100%">
	    					<tbody>
	    						<tr height="30px"><td width="*" align="right" style="padding:4px 15px 0 5px; font-weight:bold">
										<span>${loginID}</span>								
									</td>
								</tr>
	    					</tbody>
