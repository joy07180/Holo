...
<table width=100%> 
	<tr bgcolor="pink" height="30">
		<th>I D</th><th>Name</th><th>Info</th><th>Birthday</th>
		<th>Jno</th><th>Age</th><th>Point</th><th>Image</th>
		...
		<tr height="30">
			<td><!-- 
				1) JS , function 방식
					...
					=> #하면 페이지 이동되고 javascript:하면 안움직임
					=> 매개변수 처리에 주의 aidBList('홍길동')
					   jsp: aidBList('${member.id}') -> html   aidBList(홍길동) : Error--> 
		<!--		<a href="#" onclick="aidBList('${member.id}')">${member.id}</a>  aidBList()는 function -->
...
-->		
		...
		<td align="center">
			...
			<%-- JSfunction 사용시 <span class="ddd textlink" id="${member.id}" onclick="amDelete('${mamber.id}')">Delete</span> --%>
