...
public class Club_BoardController {
	...
	public ModelAndView rinsert(HttpServletRequest request, HttpServletResponse response,
									ModelAndView mv, Club_BoardVO vo, RedirectAttributes rttr) {
		// 1. 요청분석
		// => 성공: blist
	...
	@RequestMapping(value="/cbcrilist")
	public ModelAndView bcrilist(HttpServletRequest request, HttpServletResponse response, 
    	...
    	mv.setViewName("/ClubBoard/c_CriList");
    	return mv;
	} //bcrilist
	...
	// ** Insert : 새글등록
	@RequestMapping(value="/cbinsertf")
	public ModelAndView binsertf(HttpServletRequest request, HttpServletResponse response, ModelAndView mv) {
		mv.setViewName("/ClubBoard/c_insertForm");
		return mv;
	}
	
	@RequestMapping(value="/cbinsert", method=RequestMethod.POST)
	...
	public ModelAndView binsert(HttpServletRequest request, 
			HttpServletResponse response, ModelAndView mv, Club_BoardVO vo, RedirectAttributes rttr,
	...
	public ModelAndView bdelete(HttpServletRequest request, HttpServletResponse response, 
		...
		if ( service.delete(vo) > 0 ) {
			...
			uri = "redirect:cbdetail?seq="+vo.getSeq();
		} // Service
